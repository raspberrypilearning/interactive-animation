## Animate your sprite
Now you're going to change the appearance of your sprite. You can change the way your sprite looks when you run your project and you can make changes in a loop to create an animation effect.
