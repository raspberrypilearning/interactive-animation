...
In the example project, each sprite pops and disappears when they are clicked using a number of blocks from the `Looks`{:class="block3motion"} block menu.

--- task ---
The **Yellow Balloon** sprite moves up and down the stage, changing direction when it hits the top, sides or bottom. 
